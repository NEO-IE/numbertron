 ...
 * 
 */
public class SentLevelExtractorEntityGraph {
	...
	public SentLevelExtractorEntityGraph(String pathToMultirFiles,
	...
	/**
	 * returns a one instance one number entity graph
	 * @param arg1
	 * @param arg2
	 * @param features
	 * @return
	 */
	EntityGraph makeGraph(Argument arg1, Argument arg2, List<String> features) {
	...
	private Map<Integer, Double> getPerRelationScoreMap(List<String> features,
		...
		return FullInferenceEntityGraph.getRelationScoresPerMention(egraph, scorer, params);
